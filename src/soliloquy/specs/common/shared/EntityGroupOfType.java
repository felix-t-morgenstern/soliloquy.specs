...
public interface EntityGroupOfType<EntityType,
     ...
     *                                  of the range of items (i.e. if it is greater than or equal
     *                                  to their count)
     */
     ...
     *                                  if
     *                                  entity is null; or if groupId is non-empty, non-null, and
     ...
     *                      appears. (Order
     *                      numbers do not need to be positive, consecutive, etc; they must be
     *                      unique.)
