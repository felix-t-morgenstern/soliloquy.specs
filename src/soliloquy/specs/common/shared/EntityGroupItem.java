 ...
 */
public interface EntityGroupItem<Entity> extends HasOneGenericParam<Entity> {
	 ...
	 */
	void initializeGroup(EntityGroup<Entity> group) throws IllegalArgumentException, UnsupportedOperationException;
	 ...
	 * EntityGroup
	 */
	EntityGroup<Entity> group() throws UnsupportedOperationException;
