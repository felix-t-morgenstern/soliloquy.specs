 ...
 * @version 0.0.1
 */
public interface PairFactory extends SoliloquyClass {
	/**
	 ...
	 */
	<T1, T2> Pair<T1,T2> make(T1 item1, T2 item2) throws IllegalArgumentException;
	 ...
	 */
	<T1, T2> Pair<T1,T2> make(T1 item1, T2 item2, T1 archetype1, T2 archetype2) throws IllegalArgumentException;
}
