 ...
 * Collection; {@link ICollection} supports those operations.
 *
 ...
 */
public interface IReadOnlyCollection<V> extends Iterable<V>, ICloneable<ICollection<V>>,
        IHasOneGenericParam<V> {
    /**
     ...
     * items
     */
    boolean equals(IReadOnlyCollection<V> items);
