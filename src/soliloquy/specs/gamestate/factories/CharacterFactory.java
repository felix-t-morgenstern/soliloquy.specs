...
public interface CharacterFactory extends SoliloquyClass {
	/**
	 * This method creates a {@link Character} with a randomly-generated {@link EntityUuid}. To
	 * provide a specific EntityUuid, use {@link #make(CharacterType, EntityUuid)}.
	 ...
	 */
	Character make(CharacterType characterType, EntityUuid entityUuid)
