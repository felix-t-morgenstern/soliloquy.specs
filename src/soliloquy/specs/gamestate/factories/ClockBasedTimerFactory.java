...
public interface ClockBasedTimerFactory extends SoliloquyClass {
     ...
     * greater than or equal to firingTimestamp, or firingAction is null, or pausedTimestamp is
     * non-null while mostRecentTimestamp is null, or if pausedTimestamp is greater than
     * mostRecentTimestamp
     */
     ...
     * than or equal to 0, periodModuloOffset is less than or equal to 0 or greater than or equal
     * to periodDuration, fireAction is null, or pausedTimestamp is non-null while
     * mostRecentTimestamp is null, or if pausedTimestamp is greater than mostRecentTimestamp, or
