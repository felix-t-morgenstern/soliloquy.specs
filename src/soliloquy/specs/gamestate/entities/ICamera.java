...
import soliloquy.specs.ui.windowelements.IGameWorldView;
 ...
 * <p>
 * The Camera is fed into the {@link IGameWorldView}, which takes snapshots from the Camera, which are then
 ...
 *
 */
public interface ICamera extends IHasGlobalAccess {
	/**
	 ...
	 * their behavior in-game; {@link ICharacter#getAIType} and {@link ICharacter#data} are
