...
public interface GameEventTarget extends SoliloquyClass {
    /**
     * @return The {@link Tile} which is the target for this {@link GameMovementEvent}; may be null.
     */
    Tile tile();

    /**
     *
     * @return The {@link TileFixture} which is the target for this {@link GameMovementEvent}; may be null.
     */
