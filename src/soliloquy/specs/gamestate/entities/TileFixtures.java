 ...
 * @version 0.0.1
 */
public interface TileFixtures extends Deletable {
    /**
     ...
     */
    void add(TileFixture tileFixture) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException If and only if tileFixture is null
     */
    boolean contains(TileFixture tileFixture) throws IllegalArgumentException;
}
