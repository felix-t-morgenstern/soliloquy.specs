...
public interface FiniteAnimationRenderableFactory extends SoliloquyClass {
     ...
     * @param colorShiftProviders A list of Providers which provide ColorShifts for this Animation
     ...
     * @param mostRecentTimestamp The most recent time at which this Animation has been rendered,
     ...
     * borderColorProvider, colorShiftProviders, renderingAreaProvider, uuid,
     * updateZIndexInContainer, or removeFromContainer are null; or if pausedTimestamp is non-null,
     * and mostRecentTimestamp is either null, or before pausedTimestamp
     */
