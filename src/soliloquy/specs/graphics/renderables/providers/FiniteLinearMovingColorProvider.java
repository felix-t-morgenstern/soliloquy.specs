...
public interface FiniteLinearMovingColorProvider extends FiniteLinearMovingProvider<Color> {
     ...
     * {@link #valuesAtTimestamps} after the first, that implies a movement in hue; and this method
     * outlines whether each of those movements of hue are clockwise or counterclockwise.</i>
     * @return A List containing booleans, each of which is true if the corresponding hue movement
     * implied in {@link #valuesAtTimestamps} is clockwise, i.e. from red to green to blue
     */
