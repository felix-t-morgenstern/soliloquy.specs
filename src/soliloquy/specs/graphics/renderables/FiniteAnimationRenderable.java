 ...
 * will inform its containing {@link soliloquy.specs.graphics.rendering.ContainsRenderables} to
 * remove it.</i>
 *
...
public interface FiniteAnimationRenderable
        extends RenderableAnimation, RenderableWithArea<FiniteAnimationRenderable> {
}
