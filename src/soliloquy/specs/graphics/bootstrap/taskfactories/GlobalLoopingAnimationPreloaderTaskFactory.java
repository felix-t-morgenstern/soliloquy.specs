...
/**
 * <b>GlobalLoopingAnimationPreloaderTaskFactory</b>
 * <p>
 * This class creates a Runnable which will load an GlobalLoopingAnimation when preloading all
 * graphics (c.f. {@link soliloquy.specs.graphics.bootstrap.GraphicsPreloader})
 *
 * @param <TDefinitionDto> The DTO defining the GlobalLoopingAnimation to be created
 *
 * @author felix.t.morgenstern
 * @version 0.0.1
 */
public interface GlobalLoopingAnimationPreloaderTaskFactory<TDefinitionDto> {
    /**
