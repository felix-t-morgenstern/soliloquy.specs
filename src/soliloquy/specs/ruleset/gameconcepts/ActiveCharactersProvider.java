...
public interface ActiveCharactersProvider {
     ...
     * more information on the Character queue within a given round. Characters are added to
     * ActiveCharactersProvider when they are generated; and at the top of each round, by adding
     * every Character present in the current {@link soliloquy.specs.gamestate.entities.GameZone}.
     * It may be possible for Characters to be withheld from activeCharacters by setting some value
