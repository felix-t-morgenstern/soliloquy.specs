 ...
 *
 */
public interface ResistancesApplyWhenAltered {
	/**
	 ...
	 */
	void alterCurrentValue(Character character, int baseAmount, boolean stopAtZero, Element element,
                           AbilitySource abilitySource) throws IllegalArgumentException;
}
