 ...
 * <p>
 * If you equip an item to it and replace an item, the item you're replacing will be returned to the calling function.
 * <p>
...
public interface ICharacterEquipmentSlot extends ISoliloquyClass {
	 ...
	 * @throws IllegalArgumentException If character is null, or if character's CharacterEquipment already has a CharacterEquipmentSlot of this equipmentSlotType.
	 * @throws UnsupportedOperationException If the Character for this CharacterEquipmentSlot has already been initialized
	 */
	 ...
	 * @throws IllegalStateException If the Item currently in this slot cannot be equipped to this slot
	 * @throws UnsupportedOperationException If the Item currently in this slot cannot be equipped to this slot, or the CharacterId of this slot does not point to a Character that has this slot, or the Character has been deleted
	 */
	ICharacter character() throws IllegalStateException, UnsupportedOperationException;
	
	/**
	 * 
	 * @param equipmentSlotType - The equipmentSlotType to initialize for this CharacterEquipmentSlot
	 ...
	 * @throws IllegalStateException If the Item currently in this slot cannot be equipped to this slot, or if its Character or equipmentSlotType have not been initialized
	 * @throws UnsupportedOperationException If the Item currently in this slot cannot be equipped to this slot, or the CharacterId of this slot does not point to a Character that has this slot, or the Character has been deleted
	 */
	...
	/**
	 * @param item - This slot checks this item to see whether this item can be equipped to this slot
	 * @return True, if and only if this Item can be equipped to this slot
	 * @throws IllegalArgumentException If item is null
	 * @throws IllegalStateException If the Item currently in this slot cannot be equipped to this slot, or the CharacterId of this slot does not point to a Character that has this slot, or the Character has been deleted, or if its Character or equipmentSlotType have not been initialized
	 */
	 ...
	 * <p>
	 * (This method is encouraged to call unequipEquipmentFromSlot before equipping an Item to this slot.)
	...
	/**
	 * This method is intended to return false for Items that cannot be removed, e.g. Items magically bound to the Character or grafted onto their body
	 ...
	 * @throws UnsupportedOperationException If there is no Item in this slot, or the Item currently in this slot cannot be removed from this slot
	 * @throws IllegalStateException If the Item currently in this slot cannot be equipped to this slot, or the CharacterId of this slot does not point to a Character that has this slot, or the Character has been deleted, or if its Character or equipmentSlotType have not been initialized
	 */
