...
public interface ICharacterEquipmentSlots extends IDeletable {
     ...
     * Character has been deleted
     */
    IItem removeCharacterEquipmentSlot(String equipmentSlotType)
            throws IllegalArgumentException, IllegalStateException;
     ...
     * Character has been deleted
     */
    IItem itemInSlot(String equipmentSlotType)
            throws IllegalArgumentException, IllegalStateException;
     ...
     * @throws IllegalArgumentException If and only if equipmentSlotType is null or empty, or if
     * equipmentSlotType does not exist for this Character, or if item is null
     * @throws IllegalStateException If this Character does not have a GameZone, or if this
     * Character has been deleted
     */
    boolean canEquipItemToSlot(String equipmentSlotType, IItem item)
            throws IllegalArgumentException, IllegalStateException;

    /**
     * <b>To unequip items from slots, set item to be null.</b>
     * @param equipmentSlotType - The equipment slot in which to equip item
     * @param item - The Item to equip to this slot. <b>This may be null, in the case where an Item
     *             is being unequipped from the slot.</b>
     * @return The Item previously equipped to this slot (if any)
     * @throws IllegalArgumentException If and only if equipmentSlotType is null or empty, or if
     * equipmentSlotType does not exist for this Character, or if item is null, or if item cannot
     ...
     */
    IItem equipItemToSlot(String equipmentSlotType, IItem item)
