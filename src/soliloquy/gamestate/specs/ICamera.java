 ...
 * <p>
 * The Camera is fed into the GameWorldView, which takes snapshots from the Camera, which are then
...
public interface ICamera extends IGlobalAccess {
	 ...
	 * @throws IllegalArgumentException If the loc is illegal, e.g. if it is null, if it points to
	 * a nonexistent Tile, etc.
	 */
