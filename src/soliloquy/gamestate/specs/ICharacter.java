 ...
 * <p>
 * Characters exist in a GameZone; they may have a Tile; they may have a Type; they may have CharacterClassifications; they may have inventory and equipment; they may have Aptitudes, Attributes, VitalAttributes and StatusEffects; they have AI scripts; they may have Abilities; they may be hidden; and they may be dead. 
 * 
...
public interface ICharacter extends IGameEntity, IHasUuid, ISoliloquyClass {	
	 ...
	 * @throws IllegalStateException If the Tile does not exist, or if the Tile does not have this Character present in its Collection of Characters, or if the Tile is null and the Character is neither hidden nor dead, or if this Character does not have a GameZone, or if this Character has been deleted, or if this Character has no Id
	 */
	ITile getTile() throws IllegalStateException;
	
	/**
	 * @param tile - The Tile to which to move this Character
	 * @throws IllegalArgumentException If the location is illegal, e.g. if there is no Tile at that location, if loc is null, etc.
	 * <p>
	 * <i>If loc specifies a Tile with a different Character already present, you may wish to throw an IllegalArgumentException, or report a warning in the Logger.
	 * @throws IllegalStateException If this Character does not have a GameZone, or if this Character has been deleted, or if it has no Id
	 */
	 ...
	 * <p>
	 * Traits may also be irrelevant to combat or stats, e.g. religion, alignment, race, nationality
	 * <p>
	 * <i>This object is instantiated by {@link ICharacterType}. When it is instantiated, it should be set up so that the required traits are guaranteed to be present, and cannot be deleted. It should also be set up so that changes to certain traits, e.g. experience points or Character level, trigger custom behavior.</i>
	...
	/**
	 * @return The stance of the Character; e.g. "combat-ready", "attacking", "near-death"; which is used to determine its current Sprite
	 * @throws IllegalStateException If this Character does not have a GameZone, or if this Character has been deleted, or if it has no Id
	 */
	 ...
	 * @throws IllegalArgumentException If the provided direction is illegal, e.g. if it is null, a blank string, not a valid direction
	 * @throws IllegalStateException If this Character does not have a GameZone, or if this Character has been deleted, or if it has no Id
	 */
	 ...
	 * @throws IllegalArgumentException You <i>may</i> wish to throw this exception if the provided SpriteSet is null
	 * @throws IllegalStateException If this Character does not have a GameZone, or if this Character has been deleted, or if it has no Id
	 */
	 ...
	 * <p>
	 * Hidden Characters do not interact with the GameWorld; they exist only to appear (or reappear) later.
	 * @throws IllegalStateException If this Character does not have a GameZone, or if this Character has been deleted, or if it has no Id
	 */
	...
	/**
	 * If a Character is killed by setIsDead, they will not produce their default death Animations/Sounds, they will not drop Items, etc.
	...
	/**
	 * Killing a Character is different from setting a Character to be dead through setIsDead. If a Character is killed via kill, they will display their normal death Animations/Sounds, they will drop their Items, etc.
	 * <p>
	 * Killing a Character by kill is intended to trigger an event in the Character's AI script, e.g. "KILLED" 
	...
	/**
	 * Deletes this Character. (Calling this method will remove this Character from its GameZone's Characters.)
	 * <p>
	 * This is different from killing this Character or setting them to be dead via setIsDead. In those cases, the Character still exists in the GameZone's Characters, and may be revived; when a Character is deleted, they do not exist anymore at all.
	 * @throws IllegalStateException If this Character does not have a GameZone, or if this Character has been deleted, or if it has no Id
	 */
