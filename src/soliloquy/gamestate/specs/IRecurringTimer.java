 ...
 * <b>RecurringTimer</b>
 * <p>
 * Recurring timers are determined by performing a modulo function on the number of the current Round.
 * <p>
 * So, for instance, if roundModulo() returns 3, then the RecurringTimer will fire on every third turn.
 * <p>
 * There is also an offset. So, if roundModulo() returns 3 and roundOffset() returns 1, the RecurringTimer will fire on rounds 1, 4, 7, etc. 
 * 
...
public interface IRecurringTimer extends ITimer {
	 ...
	 * @throws IllegalArgumentException If roundModulo is less than one, or if it is less than or equal to roundOffset
	 */
	 ...
	 * @throws IllegalArgumentException If roundOffset is less than zero, or greater than or equal to roundModulo
	 */
