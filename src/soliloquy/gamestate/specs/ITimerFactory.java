 ...
 * <p>
 * Intended both to initially create a timer initially, as well as to regenerate timers stored in a save file.
 * 
...
public interface ITimerFactory {
	 ...
	 * @throws IllegalArgumentException If and only if timerTypeId doesn't correspond to a valid TimerType, or if roundWhenGoesOff is less than 1, or if roundWhenGoesOff has already elapsed.
	 */
	 ...
	 * @throws IllegalArgumentException If and only if timerTypeId doesn't correspond to a valid TimerType, or if roundsBetweenFiring is less than 1, or if roundsBeforeFiring is less than 1 or greater than roundsBetweenFiring
	 */
