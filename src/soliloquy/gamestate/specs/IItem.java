 ...
 * <p>
 * An Item can be located in one of these four locations: Character inventories, CharacterEquipmentSlots, Tiles, and TileContainers.
 * 
...
public interface IItem extends IGameEntity, IHasUuid {
	...
	/**
	 * @return The number of charges left in this Item (If this Item does not have charges, this method will return null.)
	 * @throws IllegalStateException If this Item's ItemType does not allow it to have charges, if this Item is present in more than one place (i.e. an Inventory, an EquipmentSlot, a Tile, or a TileContainer), or if it has no Id, or if it has been deleted. It is legal for an Item to have no locations, e.g. when it has not yet been placed, or after it has been removed from an EquipmentSlot.
	 */
	Integer getCharges() throws IllegalStateException;
	
	/**
	 * @return
	 * @throws IllegalStateException If this Item's ItemType does not allow it to be stacked, if this Item is present in more than one place (i.e. an Inventory, an EquipmentSlot, a Tile, or a TileContainer), or if it has no Id, or if it has been deleted. It is legal for an Item to have no locations, e.g. when it has not yet been placed, or after it has been removed from an EquipmentSlot.
	 */
	Integer getNumberInStack() throws IllegalStateException;
	
	/**
	 * Splits a stackable Item into two Items; returns the new Item with a number taken from the original Item's stack
	 ...
	 * @throws IllegalArgumentException - If numberToTake is less than one, or if it is greater than or equal to getNumberInStack of this (i.e. the original) Item
	 * @throws IllegalStateException - If this Item is present in more than one place (i.e. an Inventory, an EquipmentSlot, a Tile, or a TileContainer), or if it has no Id, or if it has been deleted. It is legal for an Item to have no locations, e.g. when it has not yet been placed, or after it has been removed from an EquipmentSlot.
	 */
	 ...
	 * @throws IllegalStateException If this Item is present in more than one place (i.e. an Inventory, an EquipmentSlot, a Tile, or a TileContainer), or if it has no Id, or if it has been deleted. It is legal for an Item to have no locations, e.g. when it has not yet been placed, or after it has been removed from an EquipmentSlot.
	 * @throws UnsupportedOperationException If this Item cannot be removed from its current location
	 */
	void setInventoryCharacterId(String charId) throws IllegalStateException, UnsupportedOperationException;
	
	/**
	 * @return The CharacterEquipmentSlot in which this Item is stored (If it is not in a CharacterEquipmentSlot, this returns null.)
	 * @throws IllegalStateException If this Item is present in more than one place (i.e. an Inventory, an EquipmentSlot, a Tile, or a TileContainer), or if it has no Id, or if it has been deleted. It is legal for an Item to have no locations, e.g. when it has not yet been placed, or after it has been removed from an EquipmentSlot.
	 */
	...
	/**
	 * @return The Tile on which this Item is stored (Note that this means on the ground, and not in a container.)
	 * @throws IllegalStateException If this Item is present in more than one place (i.e. an Inventory, an EquipmentSlot, a Tile, or a TileContainer), or if it has no Id, or if it has been deleted. It is legal for an Item to have no locations, e.g. when it has not yet been placed, or after it has been removed from an EquipmentSlot.
	 */
