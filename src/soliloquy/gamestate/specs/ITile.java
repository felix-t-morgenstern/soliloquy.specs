 ...
 * <p>
 * May have a GroundType, TileFixtures, TileWallSegments, Characters, Items, ActiveAbilities, ReactiveAbilities, and Sprites
 * 
...
public interface ITile extends IGameEntity {
	 ...
	 * @throws IllegalStateException If the GameZone does not contain this Tile at the location specified by getLocation
	 */
	 ...
	 * @throws IllegalArgumentException If either gameZone or location are null, or if gameZone does not have this Tile at the provided location
	 * <p>
	 * <i>(If you want to enforce minimum or maximum values for height, you should enforce that invariant here, and throw this exception.)
	 ...
	 * @throws IllegalStateException If the location is defined, but the gameZone is not; or if the gameZone does not have this Tile listed at the value returned by this method; or if this Tile has been deleted
	 */
	ICoordinate getLocation() throws IllegalStateException;
	
	/**
	 * (This is intended to be called by the GameZone after it moves this Tile from one Coordinate in its Map to another)
	 * @param location - The location to set for this Tile
	 * @throws IllegalArgumentException If location is not equal to the Coordinate key of this Tile in the Tiles Map of its GameZone
	 * @throws IllegalStateException If this Tile does not have a GameZone, or if this Tile has been deleted
	 */
	...
	/**
	 * @return A numbered Map of Characters, where the numerical index of the Map corresponds to the Z order of Characters on this Tile
	 * @throws IllegalStateException If any of the Characters returned by this method do not have this Tile listed as their location, or if this Tile has been deleted
	 * <p>
	 * <i>Also, if you want to forbid multiple Characters on a Tile, that condition should also throw this exception.</i>
	 */
	IMap<Integer,ICharacter> characters() throws IllegalStateException;
	
	/**
	 * @return A numbered Map of Items, where the numerical index of the Map corresponds to the Z order of Items on this Tile
	 * @throws IllegalStateException If any of the Items returned by this method do not have this Tile listed as their location, or if this Tile has been deleted
	 * <p>
	...
	/**
	 * @return A numbered Map of TileFixtures, where the numerical index of the Map corresponds to the Z order of TileFixtures on this Tile
	 * @throws IllegalStateException If this Tile has been deleted
	 */
