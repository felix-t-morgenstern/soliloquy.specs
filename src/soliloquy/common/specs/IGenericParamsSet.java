 ...
 * <p>
 * This is a set of generic parameters, identified by name, and of various types, e.g. Bools, ints, doubles, Strings, and Sprites
 * <p>
 * It can be copied. If you want to change any of these parameters, but you don't want these changes to be reflected in the original version, be sure to use the copy method. 
 * 
...
public interface IGenericParamsSet extends IReads, IWrites, ICloneable<IGenericParamsSet> {
	 ...
	 * @throws IllegalArgumentException If a param of the same name and value already exists, or if archetype is null
     * @param <T> The type of the new parameter to be added
	 */
	 ...
	 * @throws UnsupportedOperationException If a paramsSet of the specified type already exists in this GenericParamsSet
	...
	/**
	 * <i>(getParam cannot differentiate between nonexistent parameters, and parameters which are genuinely null; use paramExists to be certain)</i>
	...
	/**
	 * @return A new Collection of the parameter type names with registered paramSets in this GenericParamsSet
	 */
