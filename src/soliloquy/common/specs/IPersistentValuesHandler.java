 ...
 * <p>
 * This class takes string representations of persistent values (e.g. JSON), and transforms them
 * into persistent values of the proper type in Java; and vice-versa.
 * <p>
...
public interface IPersistentValuesHandler extends ISoliloquyClass {
	...
	/**
	 * This method takes a String representation of a collection of values, and performs a
	 * specified Action on each result.
	 ...
	 * @return A representation of the value provided, to be read and translated into the
	 * appropriate type
	 */
