 ...
 * <p>
 * <i>Intended use is for making sure that classes are stored properly in GenericParamsSets, or written properly to file as Persistent Variables. The generic types of this interface are intended to always match the generic type of whatever object implements this class.</i>
 * <p>
 * <i>For classes implementing this interface, it is expected that the implementing classes will accept the archetypes in their constructors.</i>
 * 
