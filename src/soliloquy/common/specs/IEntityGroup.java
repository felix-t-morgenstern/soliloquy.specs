...
public interface IEntityGroup<Entity> extends ISoliloquyClass {
	 ...
	 * @param order The order in this EntityGroup in which the Entity appears. (Order numbers do not need to be positive, consecutive, etc; they must be unique.)
	 * @param groupId The id of the grouping to which the entity is to be added; if empty or null, it is assumed that entity is added to this group (i.e. the top-level group)
	 * @throws IllegalArgumentException If order is already used within this EntityGroup; or if entity is null; or if groupId is non-empty, non-null, and does not exist within this group
	 */
	void addEntity(Entity entity, int order, String groupId) throws IllegalArgumentException;
	
	/**
	 * @param order The order in this EntityGroup in which the child EntityGroup appears. (Order numbers do not need to be positive, consecutive, etc; they must be unique.)
	 * @param groupId The id of the grouping to be added
	 * @param parentGroupId The id of the parent group to which this grouping will be added; if empty or null, it is assumed that the new group will be added to this group (i.e. the top-level group)
	 ...
	 * @return A pair containing the Id of the grouping of the item with itemId (if it is in the top-level grouping, then null is returned), and the order of the item within that grouping
	 * @throws IllegalArgumentException If itemId is blank or null, or an item with the specified id does not exist
	 */
