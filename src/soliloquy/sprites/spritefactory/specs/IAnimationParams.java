...
public interface IAnimationParams extends ISoliloquyClass {
	/**
	 * @return The collection of AnimationFrameParams which define the individual frames of the
	 * Animation
	 */
	...
	/**
	 * @return A numbered Map, where the indexes are the milliseconds at which the sounds play
	 * (after the Animation starts playing), and the values are Collections of SoundType Ids which
	 * are played at the corresponding milliseconds, and Integers which specify the volume to play
	 * the sounds at. (Intended use is as a percentage, so 100 would imply "full" volume.)
	 */
