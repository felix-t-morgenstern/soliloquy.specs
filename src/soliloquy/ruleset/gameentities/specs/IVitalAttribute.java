...
public interface IVitalAttribute extends IActOnCharacterOnTurnAndRound, IHasPluralName, IGameEntity {
	 ...
	 * <p>
	 * This is also where to specify behavior when their CharacterVitalAttribute of theirs is altered; e.g., when their Health is altered so that it is zero or less, they should be killed
	 ...
	 * @throws IllegalArgumentException If elementType is null, character is null, character is deleted, or character is dead
	 */
