 ...
 * <p>
 * (This interface is analogous to {@link soliloquy.common.specs.IEntityGroupItem}, with the
 * difference being that if the GroupItem is a Group, it returns an
 * {@link soliloquy.ruleset.gameentities.abilities.specs.IEntityGroupWithSpriteSet} instead of an
 * {@link soliloquy.common.specs.IEntityGroup}.)
 * 
