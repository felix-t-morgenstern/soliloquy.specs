 ...
 * {@link soliloquy.specs.io.graphics.assets.Image}s and
 * {@link soliloquy.specs.io.graphics.assets.Asset}s) used by the game into memory at startup, to
...
public interface GraphicsPreloader {
     ...
     * {@link soliloquy.specs.io.graphics.assets.Image} and
     * {@link soliloquy.specs.io.graphics.assets.Asset}; and if needed, to calculate the Images' alpha
