...
public interface AudioLoader {
     ...
     * @param idsForFilenames          The Id values corresponding to all filename keys to be
     *                                 searched for within the directory identified by relativePath
     ...
     *                                 (see next param)
     * @param defaultLoopRestartMsById The millisecond mark at which provided SoundTypes default to
     ...
     *                                  null
     */
    void loadFromDirectory(String relativePath,
