 ...
 * @version 0.0.1
 */
public interface HasPluralName extends HasName {
    /**
     ...
     *                                  <p>
     *                                  <i>If the pluralName provided is a blank string, it is
     *                                  strongly encouraged to throw an
     *                                  IllegalArgumentException, or to report a warning in the
     *                                  Logger.</i>
     */
