 ...
 * <p>
 * An EntityGroupOfType is an ordered grouping of Entities of a certain type, and subgroupings of
 * that
 * EntityType.
 * <p>
...
public interface EntityGroupOfType<EntityType,
    ...
    /**
     * @return A representation of all the entities and subgroupings in this grouping
     */
    List<GroupItemType> getAllGroupedRepresentation();

    /**
     * @return A representation of all the entities in this grouping, excluding subgroupings
     */
     ...
     *                                  the range of items (i.e. if it is greater than or equal to
     *                                  their count)
     */
     ...
     * @param order   The order in this EntityGroupOfType in which the EntityType appears. (Order
     ...
     * @throws IllegalArgumentException If order is already used within this EntityGroupOfType; or
     *                                  if entity is null; or if groupId is non-empty, non-null, and
     *                                  does not exist within this group
     */
    void addEntity(EntityType entity, int order, String groupId) throws IllegalArgumentException;

    /**
     * @param order         The order in this EntityGroupOfType in which the child EntityGroupOfType
     *                      appears. (Order numbers do not need to be positive, consecutive, etc;
     *                      they must be unique.)
     ...
     *                      empty or null, it is assumed that the new group will be added to this
     *                      group (i.e. the top-level group)
     * @throws IllegalArgumentException If order is already used within this EntityGroupOfType
     */
    void newSubgrouping(int order, String groupId, String parentGroupId)
     ...
     *         top-level grouping, then null is returned), and the order of the item within that
     *         grouping
