...
public interface CharacterStatusEffects extends Deletable {
     ...
     *                      or if any positive alterations should not go above zero. For instance,
     *                      Distraction might be
     *                      the negative equivalent to Concentration; so an Ability called "Cure
     *                      Distraction" should
     *                      have "stopAtZero" set to true, so that Distraction is cured, without
     *                      causing Concentration
     *                      (i.e. positive values) to appear.
     * @param element       An optional Element specifying the source of this CharacterStatusEffect
     *                      alteration. (This might not be relevant--for instance, a Character might
     *                      always resist an
     *                      attempt at poisoning based on their resistance to the Poison element,
     *                      regardless of what is
     *                      specified here.) Can be null.
     * @param abilitySource A description of the source of the Ability, e.g. in case a Character
     *                      has specific resistances to specific Abilities, or Abilities used by a
     *                      certain monster type.
     *                      Can be null, in the case of effects without any associated Ability (e.g.
     *                      a hazard found in
     *                      nature).
     * @throws IllegalStateException    If this Character is deleted or dead
