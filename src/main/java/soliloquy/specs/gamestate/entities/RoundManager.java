...
public interface RoundManager {
     ...
     * @throws IllegalArgumentException If and only if character is null
     */
    Map<String, Object> characterRoundData(Character character) throws IllegalArgumentException;
     ...
     * <p>
     * If the Character is a new entrant into the queue, then a {@link Map} with their
     ...
     */
    void setCharacterRoundData(Character character, Map<String, Object> roundData)
            throws IllegalArgumentException;
     ...
     *         is the order of Characters in the queue, and the data paired with that Character
     *         describes all information about that Character that is specific to that round only,
     *         e.g. the Character's action points, whether they are spending the round in defensive
     *         mode, etc.
     */
    List<Pair<Character, Map<String, Object>>> characterQueueRepresentation();
